...
--
-- Audience rewrite vs connection grant:
...
-- JWT audience only selects the MCP resource. Family OS still requires an
-- active mcp_connection_grants row for (user_id, oauth_client_id) before it
-- serves health tools.
--
-- Deploy:
...
begin
  ...
  -- Connection grants are enforced in the Family OS API, not in this hook.
